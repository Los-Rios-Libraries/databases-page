...
function writeDBInfo($db, $url) {
    ...
    $name = $db -> name;
    if (preg_match('/Auto|Artstor|Nexis|Country|Cq|Crc|Digital Thea|INTELECOM|Kanopy|Opposing|SAGE|ScienceDirect|Statista|CollegeSource|Ethnologue|Ovid/', $name) === 1) {
        $searchButton = '';
    }
    $output .= $searchButton;

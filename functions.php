...
function writeDBInfo($db, $url) {
    ...
    $name = $db -> name;
    if (preg_match('/Bloomsbury|Coronavirus|Country|Cq|Dailies|Digital Thea|Drama Online|Kanopy|Opposing|CollegeSource|Ethnologue|Health Reference|ProQuest/', $name) === 1) {
        $searchButton = '';
    }
    $output .= $searchButton;

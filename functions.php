...
function writeDBInfo($db, $url) {
    ...
    $name = $db -> name;
    if (preg_match('/Auto|Artstor|Nexis|Country|Cq|Crc|INTELECOM|Kanopy|Opposing|Safari|ScienceDirect|Statista|CollegeSource|Ethnologue|Cochrane Library/', $name) === 1) {
        $searchButton = '';
    }
    $output .= $searchButton;

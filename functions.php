...
function writeDBInfo($db, $url) {
    ...
    $name = $db -> name;
    if (preg_match('/Bloomsbury|Coronavirus|Country|Cq|Dailies|Digital Thea|Drama Online|Kanopy|Am Ex|Opposing|CollegeSource|Ethnologue|Health Reference|MUSE|ProQuest|Screen Studies/', $name) === 1) {
        $searchButton = '';
    }
    $output .= $searchButton;

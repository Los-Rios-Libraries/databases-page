...
function writeDBInfo($db, $url) {
    ...
    $name = $db -> name;
    if (preg_match('/Aurora|Coronavirus|Country|Dailies|(Digital|National) Thea|Flipster|Kanopy|New York Times|Opposing|CollegeSource|Ethnologue|Health Reference|ProQuest|Global Env|Docuseek|NewsWatch|Swank|InfobaseBooks|Vogue/', $name) === 1) {
        $searchButton = '';
    }
    $output .= $searchButton;

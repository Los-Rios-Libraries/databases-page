...
c.expr[":"][l.toLowerCase()]=function(a){return!!c.data(a,l)};c[k]=c[k]||{};var g=c[k][a];var h=c[k][a]=function(a,c){if(!this._createWidget)return new h(a,c);arguments.length&&this._createWidget(a,c)};c.extend(h,g,{version:e.version,_proto:c.extend({},e),_childConstructors:[]});var q=new d;q.options=c.widget.extend({},q.options);c.each(e,function(a,e){c.isFunction(e)?f[a]=function(){function c(){return d.prototype[a].apply(this,arguments)}function f(c){return d.prototype[a].apply(this,c)}return function(){var a=
this._super,d=this._superApply;this._super=c;this._superApply=f;var u=e.apply(this,arguments);this._super=a;this._superApply=d;return u}}():f[a]=e});h.prototype=c.widget.extend(q,{widgetEventPrefix:g?q.widgetEventPrefix||a:a},f,{constructor:h,namespace:k,widgetName:a,widgetFullName:l});g?(c.each(g._childConstructors,function(a,d){var e=d.prototype;c.widget(e.namespace+"."+e.widgetName,h,d._proto)}),delete g._childConstructors):d._childConstructors.push(h);c.widget.bridge(a,h);return h};c.widget.extend=
...
$(".open-db-search").on("click",function(){var c=$(this),g="";"yes"===getCookie("newWindowLinks")&&(g=' target="_blank" ');var h=c.nextAll("h3").find(".db-name"),a=h.text(),d=a.toLowerCase();d=d.replace(/ /g,"-");var e=c.nextAll("h3").find(".vendor").text().toLowerCase();e=e.replace(/[\(\):]/g,"");e=e.replace(/ /g,"-");var f=document.getElementById(d);$(".open-db-search").removeClass("hidden");var k=$(".search-one-db");if(f)c.addClass("hidden"),k.hide(),c.next(k).fadeIn(),document.getElementById(d).focus();
else{k.hide();f=h.attr("href");var l="";-1<f.indexOf("ehost")&&(l='<input type="hidden" name="ehost" value="'+f.split(/[= ]+/).pop()+'">');g="<form onsubmit=\"ga('send', 'event', 'quick search', 'submit', '"+a+'\');" class="search-one-db" method="post" action="search-db.php" '+g+'><label class="search-one-db-l" for="'+d+'">Search '+a+'</label><input name="query" id="'+d+'" type="text"><input type="hidden" name="vendor" value="'+e+'"><input type="hidden" name="db-name" value="'+d+'">'+l+'<input type="hidden" name="db-url" value="'+
encodeURIComponent(h.attr("href"))+'"><button class="search-btn" type="submit"><img height="16" width="16" src="search.png" alt="search"></button></form>';c.addClass("hidden");c.after(g);c.next(k).fadeIn();c=c.next(k).find(":text");c.focus();defaultAuto(c,"quick")}});$("#ga-opt-out").on("click",function(c){c.preventDefault();var g=screen.availHeight;c=.7*g;g*=.15;var h=screen.width/2-350,a=$(this).attr("href");window.open(a,"optOut","height="+c+", width=700, menubar=no, left="+h+", top="+g).focus()});

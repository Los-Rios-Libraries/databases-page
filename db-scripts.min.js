...
c.addClass("hidden")});checkZeros();$("dt").prev("dd").addClass("last-dd");$("#trial-dbs .db-desc").each(function(){var c=$(this),d=c.html(),h=$.trim(d).substring(0,60).split(" ").slice(0,-1).join(" ")+'... <button class="trial-desc-exp" type="button">more</button>';c.html(h);c.show();$(".trial-desc-exp").on("click",function(){$(this).parent().html(d)})})});$("#dbpage-query").on("focus",function(){showSearch($("#form-remainder"),$(this))});

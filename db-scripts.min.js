...
function homeLibEls(c){var f={arc:{cust:"amerriv",fod:"240535",gale:"sacr22807",singleCol:"a"},crc:{cust:"cosum",fod:"237206",gale:"sacr73031",singleCol:"c"},flc:{cust:"ns015092",fod:"237742",gale:"sacr88293",singleCol:"f"},scc:{cust:"sacram",fod:"106093",gale:"cclc_sac",singleCol:"s"}};$("#"+c+"-link").addClass("homelib");var h=function(a){a=a.split("-");var c=new Date;c.setFullYear(a[0],a[1]-1,a[2]);c.setHours(0);return c},a=new Date;$(".db-entry").each(function(){var d=$(this);d.data("college")&&
-1===d.data("college").indexOf(f[c].singleCol)&&d.hide();if(d.data("expiration")&&""!==d.data("expiration")){var e=h(d.data("expiration"));a>e&&d.hide()}d.data("startdate")&&""!==d.data("startdate")&&(e=h(d.data("startdate")),a<e&&d.hide())});$(".db-name:contains(OneSearch)").attr("href","https://caccl-lrccd.primo.exlibrisgroup.com/discovery/search?vid=01CACCL_LRCCD:"+c);$(".db-name:contains(Films on Demand)").attr("href","https://ezproxy.losrios.edu/login?url=http://fod.infobase.com/PortalPlayLists.aspx?wid="+
f[c].fod).data("proxy",!0);setTimeout(function(){$("#library-help-content a").on("click",function(){var a=$(this);a.text().length?a=a.text():a.find("img").length?(b=a.find("img"),a=b.attr("alt").length?b.attr("alt"):""):a="";ga("send","event",""+c+" box","click",a)})},800);showDBNos()}

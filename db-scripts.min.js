...
scrollTop:d.scrollTop(),width:d.outerWidth(),height:d.outerHeight()}}};c.fn.position=function(e){if(!e||!e.of)return E.apply(this,arguments);e=c.extend({},e);var h=c(e.of),y=c.position.getWithinInfo(e.within),u=c.position.getScrollInfo(y),m=(e.collision||"flip").split(" "),D={};var z=d(h);h[0].preventDefault&&(e.at="left top");var w=z.width;var x=z.height;var A=z.offset;var p=c.extend({},A);c.each(["my","at"],function(){var a=(e[this]||"").split(" ");1===a.length&&(a=l.test(a[0])?a.concat(["center"]):
k.test(a[0])?["center"].concat(a):["center","center"]);a[0]=l.test(a[0])?a[0]:"center";a[1]=k.test(a[1])?a[1]:"center";var c=t.exec(a[0]);var d=t.exec(a[1]);D[this]=[c?c[0]:0,d?d[0]:0];e[this]=[q.exec(a[0])[0],q.exec(a[1])[0]]});1===m.length&&(m[1]=m[0]);"right"===e.at[0]?p.left+=w:"center"===e.at[0]&&(p.left+=w/2);"bottom"===e.at[1]?p.top+=x:"center"===e.at[1]&&(p.top+=x/2);var C=a(D.at,w,x);p.left+=C[0];p.top+=C[1];return this.each(function(){var d,l=c(this),k=l.outerWidth(),r=l.outerHeight(),v=
parseInt(c.css(this,"marginLeft"),10)||0,z=parseInt(c.css(this,"marginTop"),10)||0,t=k+v+(parseInt(c.css(this,"marginRight"),10)||0)+u.width,F=r+z+(parseInt(c.css(this,"marginBottom"),10)||0)+u.height,n=c.extend({},p),q=a(D.my,l.outerWidth(),l.outerHeight());"right"===e.my[0]?n.left-=k:"center"===e.my[0]&&(n.left-=k/2);"bottom"===e.my[1]?n.top-=r:"center"===e.my[1]&&(n.top-=r/2);n.left+=q[0];n.top+=q[1];var B={marginLeft:v,marginTop:z};c.each(["left","top"],function(a,d){if(c.ui.position[m[a]])c.ui.position[m[a]][d](n,
{targetWidth:w,targetHeight:x,elemWidth:k,elemHeight:r,collisionPosition:B,collisionWidth:t,collisionHeight:F,offset:[C[0]+q[0],C[1]+q[1]],my:e.my,at:e.at,within:y,elem:l})});e.using&&(d=function(a){var c=A.left-n.left,d=c+w-k,y=A.top-n.top,u=y+x-r,v={target:{element:h,left:A.left,top:A.top,width:w,height:x},element:{element:l,left:n.left,top:n.top,width:k,height:r},horizontal:0>d?"left":0<c?"right":"center",vertical:0>u?"top":0<y?"bottom":"middle"};w<k&&g(c+d)<w&&(v.horizontal="center");x<r&&g(y+
u)<x&&(v.vertical="middle");f(g(c),g(d))>f(g(y),g(u))?v.important="horizontal":v.important="vertical";e.using.call(this,a,v)});l.offset(c.extend(n,{using:d}))})};c.ui.position={fit:{left:function(a,c){var d=c.within,e=d.isWindow?d.scrollLeft:d.offset.left,g=d.width,l=a.left-c.collisionPosition.marginLeft;d=e-l;var h=l+c.collisionWidth-g-e;c.collisionWidth>g?0<d&&0>=h?(e=a.left+d+c.collisionWidth-g-e,a.left+=d-e):a.left=0<h&&0>=d?e:d>h?e+g-c.collisionWidth:e:a.left=0<d?a.left+d:0<h?a.left-h:f(a.left-
l,a.left)},top:function(a,c){var d=c.within,e=d.isWindow?d.scrollTop:d.offset.top,g=c.within.height,h=a.top-c.collisionPosition.marginTop;d=e-h;var l=h+c.collisionHeight-g-e;c.collisionHeight>g?0<d&&0>=l?(e=a.top+d+c.collisionHeight-g-e,a.top+=d-e):a.top=0<l&&0>=d?e:d>l?e+g-c.collisionHeight:e:a.top=0<d?a.top+d:0<l?a.top-l:f(a.top-h,a.top)}},flip:{left:function(a,c){var d=c.within,e=d.offset.left+d.scrollLeft,f=d.width,l=d.isWindow?d.scrollLeft:d.offset.left,h=a.left-c.collisionPosition.marginLeft;
d=h-l;var k=h+c.collisionWidth-f-l;h="left"===c.my[0]?-c.elemWidth:"right"===c.my[0]?c.elemWidth:0;var m="left"===c.at[0]?c.targetWidth:"right"===c.at[0]?-c.targetWidth:0,r=-2*c.offset[0];if(0>d){if(e=a.left+h+m+r+c.collisionWidth-f-e,0>e||e<g(d))a.left+=h+m+r}else 0<k&&(e=a.left-c.collisionPosition.marginLeft+h+m+r-l,0<e||g(e)<k)&&(a.left+=h+m+r)},top:function(a,c){var d=c.within,e=d.offset.top+d.scrollTop,f=d.height,h=d.isWindow?d.scrollTop:d.offset.top,l=a.top-c.collisionPosition.marginTop;d=l-
h;var k=l+c.collisionHeight-f-h;l="top"===c.my[1]?-c.elemHeight:"bottom"===c.my[1]?c.elemHeight:0;var m="top"===c.at[1]?c.targetHeight:"bottom"===c.at[1]?-c.targetHeight:0,t=-2*c.offset[1];if(0>d){if(e=a.top+l+m+t+c.collisionHeight-f-e,0>e||e<g(d))a.top+=l+m+t}else 0<k&&(e=a.top-c.collisionPosition.marginTop+l+m+t-h,0<e||g(e)<k)&&(a.top+=l+m+t)}},flipfit:{left:function(){c.ui.position.flip.left.apply(this,arguments);c.ui.position.fit.left.apply(this,arguments)},top:function(){c.ui.position.flip.top.apply(this,
...
c("<div>").text(d).appendTo(this.liveRegion)}}})});function showDBNos(){var c=$("#main .db-name:visible").length,g=$("#show-db-no");g.length&&(70>c?(dbNoS=c.toString(),$("#db-no").text(dbNoS),1===c&&g.html(g.html().replace("Databases","Database")),g.attr("class","show")):g.attr("class","hidden").attr("aria-hidden","true"))}
...
c);!0===/lex[ui]s(( )?nex[iu]s)?|nex[iu]s/.test(c)?location.href="special.php?pageTitle=nexis-uni":!0===g.test(c)?(console.log("found match"),location.href="index.php?az&query="+encodeURIComponent(c)):(c="https://ezproxy.losrios.edu/login?url=https://search.ebscohost.com/login.aspx?authtype=ip,uid&direct=true&profile=eds&bquery="+encodeURIComponent(c)+"&site=eds-live&scope=site","yes"===getCookie("newWindowLinks")?window.open(c):location.href=c)}
...
$("#type-filter button").on("click",function(){var c=$(this).text();ga("send","event","filters","click",c)});$("#dbpage-query").on("focus",function(){ga("send","event","search form","activate")});function setCookie(c){var g="";c.exp&&(g=86400,"hours"===c.unit?g/=24:"minutes"===c.unit?g=60:"months"===c.unit&&(g*=30),g="max-age="+c.exp*g+";");document.cookie=c.name+"="+c.value+"; "+g+"path=/;domain=losrios.edu"}
$(".headnav a, #choose-library button").on("click",function(){var c=$(this).text().toLowerCase();setCookie({name:"homeLibrary",value:c,exp:30})});function getCookie(c){c+="=";for(var g=document.cookie.split(";"),k=0;k<g.length;k++){for(var a=g[k];" "==a.charAt(0);)a=a.substring(1);if(0===a.indexOf(c))return a.substring(c.length,a.length)}return""}
...
"https://search.ebscohost.com/login.aspx?authtype=ip,guest&direct=true&custid="+g[c].cust+"&db=edspub&groupid=main&profile=eds&plp=1");$(".db-entry").each(function(){var a=$(this);a.data("college")&&-1===a.data("college").indexOf(g[c].singleCol)&&a.hide()});$(".db-name:contains(OneSearch)").attr("href","https://caccl-lrccd.primo.exlibrisgroup.com/discovery/search?vid=01CACCL_LRCCD:"+c);$(".db-name:contains(Films on Demand)").attr("href","https://ezproxy.losrios.edu/login?url=http://fod.infobase.com/PortalPlayLists.aspx?wid="+
g[c].fod).data("proxy",!0);setTimeout(function(){$("#library-help-content a").on("click",function(){var a=$(this);a.text().length?a=a.text():a.find("img").length?(b=a.find("img"),a=b.attr("alt").length?b.attr("alt"):""):a="";ga("send","event",""+c+" box","click",a)})},800);showDBNos()}
...
c=$("#ga-opt-out"),c.html(c.html().replace(" &amp; opt out","")))}$("#newwin-check").on("click",function(){var c=$(this),g=$(".db-name, .search-one-db, #library-help-content a, .headnav a, #pubfinder a");c.is(":checked")?(setCookie({name:"newWindowLinks",value:"yes",exp:30}),g.attr("target","_blank"),$("#search-db").prop("checked",!1)&&$("#multi-search").attr("target","_blank")):(setCookie({name:"newWindowLinks",value:"no",exp:1}),g.removeAttr("target"),$("#multi-search").removeAttr("target"))});
checkCookies("homeLibrary");checkCookies("newWindowLinks");checkCookies("lrGAOptOut");$("#choose-library button").on("click",function(){$('script[src*="libraryh3lp"]').remove();$(".zopim").remove();$(".db-entry").show();var c=$(this).text();homeLibEls(c)});var currentURL=location.href;currentURL.match("college=")&&(currentURL=currentURL.replace(/(\?|&)college.*/,""),history.replaceState(currentURL,document.title,currentURL));

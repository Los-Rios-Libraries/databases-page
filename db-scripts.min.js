...
a.addClass("active"):a.addClass("hidden")});checkZeros();$("dt").prev("dd").addClass("last-dd");$("#trial-dbs .db-desc").each(function(){var a=$(this),c=a.html(),f=$.trim(c).substring(0,60).split(" ").slice(0,-1).join(" ")+'... <button class="trial-desc-exp" type="button">more</button>';a.html(f);a.show();$(".trial-desc-exp").on("click",function(){$(this).parent().html(c)})})});$("#dbpage-query").on("focus",function(){showSearch($("#form-remainder"),$(this))});
...
function homeLibEls(a){var c,d,e;switch(a){case "arc":c="amerriv";d="240535";e="a";break;case "scc":c="sacram";d="106093";e="s";break;case "crc":c="cosum";d="237206";e="c";break;case "flc":c="ns015092";d="237742";e="f";break;default:c=""}$("#"+a+"-link").addClass("homelib");$.get("help/"+a+".php",function(a){$("#library-help-content").html(a)},"html");var f=a.toUpperCase();$("#library-help h2").html("From the "+f+" Library");$("#pubfinder a").attr("href","http://search.ebscohost.com/login.aspx?authtype=ip,guest&direct=true&custid="+
...
$(".open-db-search").on("click",function(){var a=$(this),c="";"yes"===getCookie("newWindowLinks")&&(c=' target="_blank" ');var d=a.nextAll("h3").find(".db-name"),e=d.text(),f=e.toLowerCase(),f=f.replace(/ /g,"-"),h=a.nextAll("h3").find(".vendor").text().toLowerCase(),h=h.replace(/[\(\):]/g,""),h=h.replace(/ /g,"-"),k=document.getElementById(f);$(".open-db-search").removeClass("hidden");var g=$(".search-one-db");k?(a.addClass("hidden"),g.hide(),a.next(g).fadeIn(),document.getElementById(f).focus()):
...
a.addClass("hidden"),a.after(c),a.next(g).fadeIn(),a.next(g).find(":text").focus())});$("#ga-opt-out").on("click",function(a){a.preventDefault();var c=screen.availHeight;a=.7*c;var c=.15*c,d=screen.width/2-350,e=$(this).attr("href");window.open(e,"optOut","height="+a+", width=700, menubar=no, left="+d+", top="+c+"").focus()});$("#remove-proxy").on("click",function(){removeProxy();setCookie("dbProxy","removed",null)});var proxySet=getCookie("dbProxy");"removed"===proxySet&&removeProxy();

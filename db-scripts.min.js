...
$("#add-ezproxy").on("click",function(){!0!==$("body").data("ezproxy")&&(removeProxy(),$("#proxy").hide(),$(".db-name").each(function(){if(!1!==$(this).data("proxy")){var c=$(this).attr("href").replace(/^/,"https://ezproxy.losrios.edu/login?url=");$(this).attr("href",c)}else-1<$(this).attr("href").indexOf("special")&&(c=$(this).attr("href").split("="),console.log(c),c=c.pop(),console.log(c),$(this).attr("href","https://ezproxy.losrios.edu/login?url="+c))}),$("body").data("ezproxy",!0),$("#ez-proxy-explanation").length||
$("#add-ezproxy").after('<p class="special">This is for trying out access via the new authentication system. Not all databases will function correcctly. To go back to the normal urls, refresh the screen or navigate to another page.</p>'))});var proxySet=getCookie("dbProxy");"removed"===proxySet&&removeProxy();

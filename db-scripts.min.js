...
c.expr[":"][l.toLowerCase()]=function(a){return!!c.data(a,l)};c[h]=c[h]||{};var k=c[h][a];var g=c[h][a]=function(a,c){if(!this._createWidget)return new g(a,c);arguments.length&&this._createWidget(a,c)};c.extend(g,k,{version:e.version,_proto:c.extend({},e),_childConstructors:[]});var q=new d;q.options=c.widget.extend({},q.options);c.each(e,function(a,e){c.isFunction(e)?f[a]=function(){function c(){return d.prototype[a].apply(this,arguments)}function f(c){return d.prototype[a].apply(this,c)}return function(){var a=
this._super,d=this._superApply;this._super=c;this._superApply=f;var u=e.apply(this,arguments);this._super=a;this._superApply=d;return u}}():f[a]=e});g.prototype=c.widget.extend(q,{widgetEventPrefix:k?q.widgetEventPrefix||a:a},f,{constructor:g,namespace:h,widgetName:a,widgetFullName:l});k?(c.each(k._childConstructors,function(a,d){var e=d.prototype;c.widget(e.namespace+"."+e.widgetName,g,d._proto)}),delete k._childConstructors):d._childConstructors.push(g);c.widget.bridge(a,g);return g};c.widget.extend=
...
_on:function(a,d,e){var f,h=this;"boolean"!==typeof a&&(e=d,d=a,a=!1);e?(d=f=c(d),this.bindings=this.bindings.add(d)):(e=d,d=this.element,f=this.widget());c.each(e,function(e,g){function l(){if(a||!0!==h.options.disabled&&!c(this).hasClass("ui-state-disabled"))return("string"===typeof g?h[g]:g).apply(h,arguments)}"string"!==typeof g&&(l.guid=g.guid=g.guid||l.guid||c.guid++);var k=e.match(/^([\w:-]*)\s*(.*)$/),n=k[1]+h.eventNamespace;if(k=k[2])f.on(n,k,l);else d.on(n,l)})},_off:function(a,d){d=(d||
...
h&&h.call(e[0]);d()})}});(function(){function a(a,c,d){return[parseFloat(a[0])*(C.test(a[0])?c/100:1),parseFloat(a[1])*(C.test(a[1])?d/100:1)]}function d(a){var d=a[0];return 9===d.nodeType?{width:a.width(),height:a.height(),offset:{top:0,left:0}}:c.isWindow(d)?{width:a.width(),height:a.height(),offset:{top:a.scrollTop(),left:a.scrollLeft()}}:d.preventDefault?{width:0,height:0,offset:{top:d.pageY,left:d.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}var e,f=Math.max,g=Math.abs,
k=/left|center|right/,n=/top|center|bottom/,t=/[\+\-]\d+(\.[\d]+)?%?/,q=/^\w+/,C=/%$/,F=c.fn.position;c.position={scrollbarWidth:function(){if(void 0!==e)return e;var a=c("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>");var d=a.children()[0];c("body").append(a);var f=d.offsetWidth;a.css("overflow","scroll");d=d.offsetWidth;f===d&&(d=a[0].clientWidth);a.remove();return e=f-d},getScrollInfo:function(a){var d=a.isWindow||
...
scrollTop:d.scrollTop(),width:d.outerWidth(),height:d.outerHeight()}}};c.fn.position=function(e){if(!e||!e.of)return F.apply(this,arguments);e=c.extend({},e);var h=c(e.of),l=c.position.getWithinInfo(e.within),u=c.position.getScrollInfo(l),A=(e.collision||"flip").split(" "),E={};var z=d(h);h[0].preventDefault&&(e.at="left top");var w=z.width;var x=z.height;var B=z.offset;var p=c.extend({},B);c.each(["my","at"],function(){var a=(e[this]||"").split(" ");1===a.length&&(a=k.test(a[0])?a.concat(["center"]):
n.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=n.test(a[1])?a[1]:"center";var c=t.exec(a[0]);var d=t.exec(a[1]);E[this]=[c?c[0]:0,d?d[0]:0];e[this]=[q.exec(a[0])[0],q.exec(a[1])[0]]});1===A.length&&(A[1]=A[0]);"right"===e.at[0]?p.left+=w:"center"===e.at[0]&&(p.left+=w/2);"bottom"===e.at[1]?p.top+=x:"center"===e.at[1]&&(p.top+=x/2);var D=a(E.at,w,x);p.left+=D[0];p.top+=D[1];return this.each(function(){var d,k=c(this),r=k.outerWidth(),y=k.outerHeight(),v=
parseInt(c.css(this,"marginLeft"),10)||0,z=parseInt(c.css(this,"marginTop"),10)||0,n=r+v+(parseInt(c.css(this,"marginRight"),10)||0)+u.width,t=y+z+(parseInt(c.css(this,"marginBottom"),10)||0)+u.height,m=c.extend({},p),q=a(E.my,k.outerWidth(),k.outerHeight());"right"===e.my[0]?m.left-=r:"center"===e.my[0]&&(m.left-=r/2);"bottom"===e.my[1]?m.top-=y:"center"===e.my[1]&&(m.top-=y/2);m.left+=q[0];m.top+=q[1];var C={marginLeft:v,marginTop:z};c.each(["left","top"],function(a,d){if(c.ui.position[A[a]])c.ui.position[A[a]][d](m,
{targetWidth:w,targetHeight:x,elemWidth:r,elemHeight:y,collisionPosition:C,collisionWidth:n,collisionHeight:t,offset:[D[0]+q[0],D[1]+q[1]],my:e.my,at:e.at,within:l,elem:k})});e.using&&(d=function(a){var c=B.left-m.left,d=c+w-r,l=B.top-m.top,u=l+x-y,v={target:{element:h,left:B.left,top:B.top,width:w,height:x},element:{element:k,left:m.left,top:m.top,width:r,height:y},horizontal:0>d?"left":0<c?"right":"center",vertical:0>u?"top":0<l?"bottom":"middle"};w<r&&g(c+d)<w&&(v.horizontal="center");x<y&&g(l+
u)<x&&(v.vertical="middle");f(g(c),g(d))>f(g(l),g(u))?v.important="horizontal":v.important="vertical";e.using.call(this,a,v)});k.offset(c.extend(m,{using:d}))})};c.ui.position={fit:{left:function(a,c){var d=c.within,e=d.isWindow?d.scrollLeft:d.offset.left,g=d.width,k=a.left-c.collisionPosition.marginLeft;d=e-k;var h=k+c.collisionWidth-g-e;c.collisionWidth>g?0<d&&0>=h?(e=a.left+d+c.collisionWidth-g-e,a.left+=d-e):a.left=0<h&&0>=d?e:d>h?e+g-c.collisionWidth:e:a.left=0<d?a.left+d:0<h?a.left-h:f(a.left-
k,a.left)},top:function(a,c){var d=c.within,e=d.isWindow?d.scrollTop:d.offset.top,g=c.within.height,k=a.top-c.collisionPosition.marginTop;d=e-k;var h=k+c.collisionHeight-g-e;c.collisionHeight>g?0<d&&0>=h?(e=a.top+d+c.collisionHeight-g-e,a.top+=d-e):a.top=0<h&&0>=d?e:d>h?e+g-c.collisionHeight:e:a.top=0<d?a.top+d:0<h?a.top-h:f(a.top-k,a.top)}},flip:{left:function(a,c){var d=c.within,e=d.offset.left+d.scrollLeft,f=d.width,k=d.isWindow?d.scrollLeft:d.offset.left,h=a.left-c.collisionPosition.marginLeft;
d=h-k;var l=h+c.collisionWidth-f-k;h="left"===c.my[0]?-c.elemWidth:"right"===c.my[0]?c.elemWidth:0;var n="left"===c.at[0]?c.targetWidth:"right"===c.at[0]?-c.targetWidth:0,r=-2*c.offset[0];if(0>d){if(e=a.left+h+n+r+c.collisionWidth-f-e,0>e||e<g(d))a.left+=h+n+r}else 0<l&&(e=a.left-c.collisionPosition.marginLeft+h+n+r-k,0<e||g(e)<l)&&(a.left+=h+n+r)},top:function(a,c){var d=c.within,e=d.offset.top+d.scrollTop,f=d.height,h=d.isWindow?d.scrollTop:d.offset.top,k=a.top-c.collisionPosition.marginTop;d=k-
h;var l=k+c.collisionHeight-f-h;k="top"===c.my[1]?-c.elemHeight:"bottom"===c.my[1]?c.elemHeight:0;var n="top"===c.at[1]?c.targetHeight:"bottom"===c.at[1]?-c.targetHeight:0,t=-2*c.offset[1];if(0>d){if(e=a.top+k+n+t+c.collisionHeight-f-e,0>e||e<g(d))a.top+=k+n+t}else 0<l&&(e=a.top-c.collisionPosition.marginTop+k+n+t-h,0<e||g(e)<l)&&(a.top+=k+n+t)}},flipfit:{left:function(){c.ui.position.flip.left.apply(this,arguments);c.ui.position.fit.left.apply(this,arguments)},top:function(){c.ui.position.flip.top.apply(this,
...
function homeLibEls(c){var g={arc:{cust:"amerriv",fod:"240535",gale:"sacr22807",singleCol:"a"},crc:{cust:"cosum",fod:"237206",gale:"sacr73031",singleCol:"c"},flc:{cust:"ns015092",fod:"237742",gale:"sacr88293",singleCol:"f"},scc:{cust:"sacram",fod:"106093",gale:"cclc_sac",singleCol:"s"}};$("#"+c+"-link").addClass("homelib");$(".db-entry").each(function(){var k=$(this);k.data("college")&&-1===k.data("college").indexOf(g[c].singleCol)&&k.hide();if(k.data("expiration")&&""!==k.data("expiration")){var a=
k.data("expiration").split("-"),d=new Date;d.setFullYear(a[0],a[1]-1,a[2]);new Date>d&&k.hide()}});$(".db-name:contains(OneSearch)").attr("href","https://caccl-lrccd.primo.exlibrisgroup.com/discovery/search?vid=01CACCL_LRCCD:"+c);$(".db-name:contains(Films on Demand)").attr("href","https://ezproxy.losrios.edu/login?url=http://fod.infobase.com/PortalPlayLists.aspx?wid="+g[c].fod).data("proxy",!0);setTimeout(function(){$("#library-help-content a").on("click",function(){var g=$(this);g.text().length?
g=g.text():g.find("img").length?(b=g.find("img"),g=b.attr("alt").length?b.attr("alt"):""):g="";ga("send","event",""+c+" box","click",g)})},800);showDBNos()}

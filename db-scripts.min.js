...
c);!0===/lex[ui]s(( )?nex[iu]s)?|nex[iu]s/.test(c)?location.href="special.php?pageTitle=nexis-uni":!0===g.test(c)?(console.log("found match"),location.href="index.php?az&query="+encodeURIComponent(c)):(c="https://www.library.losrios.edu/onesearch/?query="+encodeURIComponent(c),"yes"===getCookie("newWindowLinks")?window.open(c):location.href=c)}
$(function(){defaultAuto($("#dbpage-query"));$(".db-name").each(function(){for(var c=$(this).html().split(" "),a=/^Apa$|Cinahl|Cq|Eric|^Mas$|Medline|^Am$/,d=0;d<c.length;d++)a.test(c[d])?c[d]=c[d].toUpperCase():"Ebook"===c[d]&&(c[d]="eBook");c=c.join(" ");$(this).html(c)});var c=$("#main-nav"),g=$("#nav-label");781>$(window).width()&&c.addClass("hidden");g.on("click",function(){c.toggleClass("hidden")});$(".category").each(function(){var c=$(this);c.removeClass("active hidden");var a=c.find("li");
...
function homeLibEls(c){var g={arc:{cust:"amerriv",fod:"240535",gale:"sacr22807",singleCol:"a"},crc:{cust:"cosum",fod:"237206",gale:"sacr73031",singleCol:"c"},flc:{cust:"ns015092",fod:"237742",gale:"sacr88293",singleCol:"f"},scc:{cust:"sacram",fod:"106093",gale:"cclc_sac",singleCol:"s"}};$("#"+c+"-link").addClass("homelib");$.get("help/"+c+".php",function(a){$("#library-help-content").html(a)},"html");var k=c.toUpperCase();$("#library-help h2").html("From the "+k+" Library");$(".db-entry").each(function(){var a=
$(this);a.data("college")&&-1===a.data("college").indexOf(g[c].singleCol)&&a.hide()});$(".db-name:contains(OneSearch)").attr("href","https://caccl-lrccd.primo.exlibrisgroup.com/discovery/search?vid=01CACCL_LRCCD:"+c);$(".db-name:contains(Films on Demand)").attr("href","https://ezproxy.losrios.edu/login?url=http://fod.infobase.com/PortalPlayLists.aspx?wid="+g[c].fod).data("proxy",!0);setTimeout(function(){$("#library-help-content a").on("click",function(){var a=$(this);a.text().length?a=a.text():a.find("img").length?
(b=a.find("img"),a=b.attr("alt").length?b.attr("alt"):""):a="";ga("send","event",""+c+" box","click",a)})},800);showDBNos()}

...
g,a.left)},top:function(a,c){var d=c.within,e=d.isWindow?d.scrollTop:d.offset.top,h=c.within.height,g=a.top-c.collisionPosition.marginTop;d=e-g;var l=g+c.collisionHeight-h-e;c.collisionHeight>h?0<d&&0>=l?(e=a.top+d+c.collisionHeight-h-e,a.top+=d-e):a.top=0<l&&0>=d?e:d>l?e+h-c.collisionHeight:e:a.top=0<d?a.top+d:0<l?a.top-l:f(a.top-g,a.top)}},flip:{left:function(a,c){var d=c.within,e=d.offset.left+d.scrollLeft,f=d.width,l=d.isWindow?d.scrollLeft:d.offset.left,g=a.left-c.collisionPosition.marginLeft;
d=g-l;var k=g+c.collisionWidth-f-l;g="left"===c.my[0]?-c.elemWidth:"right"===c.my[0]?c.elemWidth:0;var m="left"===c.at[0]?c.targetWidth:"right"===c.at[0]?-c.targetWidth:0,n=-2*c.offset[0];if(0>d){if(e=a.left+g+m+n+c.collisionWidth-f-e,0>e||e<h(d))a.left+=g+m+n}else 0<k&&(e=a.left-c.collisionPosition.marginLeft+g+m+n-l,0<e||h(e)<k)&&(a.left+=g+m+n)},top:function(a,c){var d=c.within,e=d.offset.top+d.scrollTop,f=d.height,g=d.isWindow?d.scrollTop:d.offset.top,l=a.top-c.collisionPosition.marginTop;d=l-
g;var k=l+c.collisionHeight-f-g;l="top"===c.my[1]?-c.elemHeight:"bottom"===c.my[1]?c.elemHeight:0;var m="top"===c.at[1]?c.targetHeight:"bottom"===c.at[1]?-c.targetHeight:0,n=-2*c.offset[1];if(0>d){if(e=a.top+l+m+n+c.collisionHeight-f-e,0>e||e<h(d))a.top+=l+m+n}else 0<k&&(e=a.top-c.collisionPosition.marginTop+l+m+n-g,0<e||h(e)<k)&&(a.top+=l+m+n)}},flipfit:{left:function(){c.ui.position.flip.left.apply(this,arguments);c.ui.position.fit.left.apply(this,arguments)},top:function(){c.ui.position.flip.top.apply(this,
...
function defaultAuto(c){c.autocomplete({source:function(c,k){$.getJSON({url:"https://widgets.ebscohost.com/prod/simplekey/autocomplete/autocomp.php",data:{q:encodeURIComponent(c.term)}}).done(function(a){a=JSON.parse(a);var c=[];a=$.map(a,function(a,c){return[a]})[2];for(var e=0;e<a.length;e++)c.push(a[e].term),k(c)}).fail(function(a,c,e){ga("send","event","eds autosuggest","error",e)})},select:function(g,k){k.item&&c.val(k.item.value);submitSearch(c.val())}})}
...
location.href="index.php?az&query="+encodeURIComponent(c)):(c="http://0-search.ebscohost.com.lasiii.losrios.edu/login.aspx?authtype=ip,uid&direct=true&profile=eds&bquery="+encodeURIComponent(c)+"&site=eds-live&scope=site","yes"===getCookie("newWindowLinks")?window.open(c):location.href=c)}
...
function homeLibEls(c){switch(c){case "arc":var g="amerriv";var k="240535";var a="a";break;case "scc":g="sacram";k="106093";a="s";break;case "crc":g="cosum";k="237206";a="c";break;case "flc":g="ns015092";k="237742";a="f";break;default:g=""}$("#"+c+"-link").addClass("homelib");$.get("help/"+c+".php",function(a){$("#library-help-content").html(a)},"html");var d=c.toUpperCase();$("#library-help h2").html("From the "+d+" Library");$("#pubfinder a").attr("href","http://search.ebscohost.com/login.aspx?authtype=ip,guest&direct=true&custid="+
g+"&db=edspub&groupid=main&profile=eds&plp=1");$(".db-entry").each(function(){var c=$(this);c.data("college")&&-1===c.data("college").indexOf(a)&&c.hide()});$(".db-name:contains(Films on Demand)").attr("href","http://0-fod.infobase.com.lasiii.losrios.edu/PortalPlayLists.aspx?wid="+k);setTimeout(function(){$("#library-help-content a").on("click",function(){var a=$(this);a.text().length?a=a.text():a.find("img").length?(b=a.find("img"),a=b.attr("alt").length?b.attr("alt"):""):a="";ga("send","event",
""+c+" box","click",a)})},800);showDBNos()}
function checkCookies(c){"homeLibrary"===c?((c=getCookie(c))?homeLibEls(c):$.get("help/unknown.php",function(c){$("#library-help-content").html(c)},"html"),console.log(c)):"newWindowLinks"===c?"yes"===getCookie(c)&&($("#newwin-check").prop("checked",!0),$(".db-name, .headnav a, #pubfinder a, #multi-search").attr("target","_blank"),setTimeout(function(){$("#library-help-content a").attr("target","_blank")},1E3)):"lrGAOptOut"===c&&"y"===getCookie(c)&&($("#ga-status").prepend(" You have opted out of tracking. "),c=
$("#ga-opt-out"),c.html(c.html().replace(" &amp; opt out","")))}$("#newwin-check").on("click",function(){var c=$(this),g=$(".db-name, .search-one-db, #library-help-content a, .headnav a, #pubfinder a");c.is(":checked")?(setCookie("newWindowLinks","yes",30),g.attr("target","_blank"),$("#search-db").prop("checked",!1)&&$("#multi-search").attr("target","_blank")):(setCookie("newWindowLinks","no",1),g.removeAttr("target"),$("#multi-search").removeAttr("target"))});checkCookies("homeLibrary");checkCookies("newWindowLinks");
